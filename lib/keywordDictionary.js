...
const DICCIONARIO = {
  ...
  // NUEVO: rotisería. Cubre pollo al horno, empanadas y comida lista para
  // llevar que no encaja bien ni en "carnicería" ni en "almacén".
  rotiseria: {
    categoria: "rotisería",
    palabras: [
      "rotisería",
...
const CATEGORIAS_ESTANDAR = [...new Set(Object.values(DICCIONARIO).map((e) => e.categoria))].sort();
module.exports = {
  DICCIONARIO,
